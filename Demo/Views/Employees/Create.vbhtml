...
<section class=" card-body shadow-sm p5">
    ...
    <div style="position:absolute;left:19%">
        <div class="bcca-breadcrumb uk-margin-auto uk-margin-ri">
            <div class="bcca-breadcrumb-item">Create employee &nbsp;<i style="color:#451C16" class="fa fa-user"></i></div>
        </div>
    </div>
    <br />
    <br />
        ...
        @Using (Html.BeginForm())
            ...
            @<div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <br />
                    <br />
                    @Html.DropDownList("DepartmentId", Nothing, htmlAttributes:=New With {.class = "form-control-lg uk-select"})
